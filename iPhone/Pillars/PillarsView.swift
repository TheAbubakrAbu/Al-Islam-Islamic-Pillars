        ...
        NavigationView {
            List {
                ...
                Section(header: Text("THE BASICS")) {
                    NavigationLink(destination: IslamView()) {
                        Text("What is Islam?")
                    ...
                    NavigationLink(destination: AllahView()) {
                        Text("Who is Allah?")
                            .foregroundColor(settings.accentColor.color)
                            .font(.headline)
                    }
                    ...
                    NavigationLink(destination: ProphetView()) {
                    ...
                    NavigationLink(destination: SunnahView()) {
    ...
    var body: some View {
        List {
            ...
            Section(header: Text("PREVIOUS SCRIPTURES")) {
                ...
                Text("“The best among you (Muslims) are those who learn the Qur'an and teach it.” (Sahih al-Bukhari 5027)")
                    .font(.body)
                    .foregroundColor(settings.accentColor.color)
            }
    ...
    var body: some View {
        List {
            ...
            Section(header: Text("TYPES OF HADITHS")) {
                ...
                Text("“The best among you (Muslims) are those who learn the Qur'an and teach it.” (Sahih al-Bukhari 5027)").font(.body).foregroundColor(settings.accentColor.color)
